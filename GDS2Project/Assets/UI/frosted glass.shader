        ...
        SubShader
        {
            ...
            Pass
            {
                ...
                half4 GrabPixel(v2f i, float weight, float kernelx)
                {
                    ...
                    return tex2Dproj(_GrabTexture,
                        UNITY_PROJ_COORD(
                            float4(i.uvgrab.x + _GrabTexture_TexelSize.x*kernelx*_Size, i.uvgrab.y, i.uvgrab.z, i.uvgrab
                                .w))) * weight;
                }
            ...
            Pass
            {
                ...
                half4 GrabPixel(v2f i, float weight, float kernely)
                {
                    ...
                    return tex2Dproj(_GrabTexture,
                        UNITY_PROJ_COORD(
                            float4(i.uvgrab.x, i.uvgrab.y + _GrabTexture_TexelSize.y*kernely*_Size, i.uvgrab.z, i.uvgrab
                                .w))) * weight;
                }
